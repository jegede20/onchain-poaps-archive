      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        <div className="flex flex-col lg:flex-row gap-8 justify-between">
          <div className="min-w-0">
            <div className="font-display text-lg font-medium tracking-tight">Onchain POAPs — Archive</div>
          ...
          <div className="flex flex-col sm:flex-row gap-8 lg:gap-12 text-sm">
            <div>
              <div className="font-medium text-xs uppercase tracking-[0.14em] text-muted">Protocol</div>
            ...
            <div>
              <div className="font-medium text-xs uppercase tracking-[0.14em] text-muted">Archive</div>
